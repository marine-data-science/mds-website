...
summary: >-
  Neuro-symbolic models for activity recognition that use domain knowledge and
  constraints.
image: ../assets/research/neuro-symbolic-human-activity-recognition/nesy-har.png
imageAlt: Neuro-Symbolic Human Activity Recognition
