...
- Familiarity with Python, deep learning, PyTorch, NumPy, and Hugging Face
...
#### Open HiWi Positions
Not eligible for the semester project, but want to work on exciting topics anyway? We are currently hiring students for thesis and HiWi positions at the lab. Send us an [email](mailto:ashwin.nedungadi@uni-rostock.de?subject=EgoProject%202026) if interested.
