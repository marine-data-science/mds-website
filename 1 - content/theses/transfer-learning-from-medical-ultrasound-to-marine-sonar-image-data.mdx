...
**Training Neural Network:** Implementing and applying a training pipeline to train a neural network for an application such as object detection or segmentation
...
**Impact Analysis**: Comparing the performance of medical US-trained models to traditional sonar-specific approaches
